...
app.controller("DetailsController", function ($scope, $http, $routeParams, $rootScope, $location) {
    ...
    $scope.like = function () {
        if (!$rootScope.currentUser) {
            ...
            $http.get("https://api.foursquare.com/v2/venues/explore?offset=0&limit=50&section=sights&near=" + place + "&radius=40233.60&client_id=GSIEU2B3JTCYFZ35EKBEYDTI0ZVDWDHN31WY3RHKQ1O0UD5Q&client_secret=FNIT5VXIUSLDHGDLIHY3EIF3EAUWJIHQSMUCA5TDWXEA40MQ&v=20121215")
